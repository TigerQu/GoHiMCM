...
DEFAULT_CONFIG = {
    ...
    # fire intensity configuration
    # these control continuous fire/smoke intensity modeling (0-1 scale)
    # instead of binary on/off states - more realistic hazard representation
    ...
    # mobility-specific vulnerability multipliers
    # account for physiological differences in hazard tolerance:
    ...
    "responder_Xi_max": 100.0,       # max cumulative exposure before forced withdrawal
